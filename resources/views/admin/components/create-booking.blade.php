        ...
        <div class="row justify-content-center">         
            <div class="col-md-5">  
                <div class="mb-3">
                    ...
                    <input type="text" value="{{ old('destination_name')}}"  name="manufacturer"   class="form-control @error('manufacturer') text-danger is-invalid @enderror"  placeholder="enter your destination name">            
                </div>       
            </div>
            <div class="col-md-5">
                <div class="mb-3">
                    <label for="">Car Price:</label>
                    <input type="number" value="{{ old('car_price')}}"  name="car_price"  class="form-control @error('car_price') text-danger is-invalid @enderror"   placeholder="enter your desination price">
        ...
        <div class="row justify-content-center"> 
            <div class="col-md-5">      
                <div class="mb-3">
                    ...
                    <input type="text" value="{{ old('model')}}"  name="model"  class="form-control @error('model') text-danger is-invalid @enderror"   placeholder="enter your desination price">
                       </select>
            ...
            <div class="col-md-5">
                <div class="mb-3">
                    ...
                    <input type="text" value="{{ old('capacity')}}"  name="capacity"  class="form-control @error('capacity') text-danger is-invalid @enderror"   placeholder="enter your desination price">
                </select>       
        ...
        <div class="row justify-content-center"> 
            <div class="col-md-5">      
                <div class="mb-3">
                    ...
                    <input type="text" value="{{ old('fuel_type')}}"  name="fuel_type"  class="form-control @error('fuel_type') text-danger is-invalid @enderror"   placeholder="enter your desination price">
                </select> 
            ...
            <div class="col-md-5">
                <div class="mb-3">
                    ...
                    <input type="text" value="{{ old('color')}}"  name="color"  class="form-control @error('color') text-danger is-invalid @enderror"   placeholder="enter your desination price">
                </select>
