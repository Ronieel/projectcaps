    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <!-- <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="mb-3">
                        <h1 class="h3 mb-0 text-muted float-start">Manage Booking</h1>
                ...
                <div class="col-md-6 ">
                    <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
                        ...
                        <div>
                            <a href="{{ route('create_booking') }}" class="btn btn-primary"><i class="bx bx-plus"></i> Add New</a>
                        </div>
                        <div class="dropdown">
            ...
            success: function(response) {
                ...
                $.each(response, function(index, booking) {
                    var row = `
                        <tr class="bg-light">
                            <td>${index + 1}</td>
                            <td class="text-muted">${booking.Car_type}</td>
                            <td class="text-muted">${booking.Manufacturer}</td>
                            <td class="text-muted">${booking.Car_price}</td>
                            <td class="text-muted">${booking.Capacity}</td>
                            <td>
                                <ul class="list-inline mb-0">
                                    ...
                                    <li class="list-inline-item">
                                        <a href="/edit-booking/${booking.id}" onclick="editDestination(${booking.id})" class="btn btn-sm btn-warning">
